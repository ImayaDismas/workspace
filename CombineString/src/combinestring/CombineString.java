package combinestring;
//We are given 3 strings: str1, str2, and str3. 
//Str3 is said to be a shuffle of str1 and str2 if it can be formed by interleaving the characters of str1 
//and str2 in a way that maintains the left to right ordering of the characters from each string. 
//For example, given str1="abc" and str2="def", str3="dabecf" is a valid shuffle since it 
...
public class CombineString {
	...
	public static void main(String[] args) {
		...
		String a = "abc", b = "def", c = "dabecf";

		System.out.println("String is a valid shuffle: " + isInterleaved(a.toCharArray(),b.toCharArray(),c.toCharArray()));
